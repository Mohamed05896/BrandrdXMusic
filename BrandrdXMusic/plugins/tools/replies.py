...
SAD_QUOTES = [
    ...
    "كـانـوا لـقـلـي حـيـاة والـيـوم هـم لـقـلـبـي وجـع 🖤🥀", "تـوقـف عـن لـوم نـفـسـك فـالـمـغـادر لـم يـكـن يـسـتـحـقـك 🖤🥀",
...
SWEET_QUOTES = [
    ...
    "أنـتِ الـنـبـض الـذى أعـيـش بـه 💗🧚", "لا أࢪيـد شـيـئـاً سـوى أن تـبـقـي بـجـان_بـي 💗🧚",
...
async def whisper_boda(_, m: Message):
    ...
    if not m.reply_to_message: return await m.reply_text("• بـالـࢪد يـا ع_مـࢪي")
    w_id = f"w_{m.id}"
