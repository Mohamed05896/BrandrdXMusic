...
# --- [ إعـدادات الـداتـا بـيـز ] ---
db = mongodb.boda_final_complete
locks_db = mongodb.BrandrdDB.locks
whispers_db = {} 
...
SAD_QUOTES = [
    ...
    "كـانـوا لـقـلـبـي حـيـاة والـيـوم هـم لـقـلـبـي وجـع 🖤🥀", "تـوقـف عـن لـوم نـف_سـك فـالـمـغـادر لـم يـكـن يـسـتـحـقـك 🖤🥀",
    ...
    "خـخـسـࢪنـاهـم لأنـهـم أࢪادوا الـخـسـاࢪة 🖤🥀", "كـنـت الـمـأوى الـوحـيـد والآن أنـت الـغـࢪيـب 🖤🥀",
    ...
    "كـأن الـدنـيـا أجـمـعـت عـلـى أن تـكـسـࢪنـي 🖤🥀", "بـيـنـي وبـيـن الـࢪاحـة جـدار مـن ال_تـعـب 🖤🥀",
    "الـحـمـد لـلـه عـلـى كـل جـࢪح جـعـلـنـا أقـوى 🖤🥀", "انـتـهـى كـل شـيء وبـقـي الـوجـع 🖤🥀"
]

# --- [ 50 عـبـاࢪة حـلـوة كـامـلـة ] ---
SWEET_QUOTES = [
    ...
    "سـأبـقـى أحـبـكِ ح_تـى تـتـوقـفُ الـن_بـضـات 💖🥀", "أنـتِ الـنـعـمـةُ الـتـي أشـكـرُ الـلـه عـلـيـهـا 💖🥀",
    "بـجـانـبـكِ فـقـط أشـعـرُ أن الـحـيـاةَ بـخـيـر 💖🥀", "يـا حـظ قـلـبـي فـيـك ويـا بـخـت عـيـنـي 💖🥀",
    "ضـحـكـتـكِ هـي الـمـوسـيـقـى الـتـي تـهـدئ قـلـبـي 💖🥀", "أنـتِ الـفـكـࢪةُ الـجـmـيـلـة الـتـي أبـتـدئُ بـهـا يـومـي 💖🥀",
    ...
    "أنـتِ ال_نـبـض الـذى أعـيـش بـه 💖🥀", "لا أࢪيـد شـيـئـاً سـوى أن تـبـقـي بـجـانـبـي 💖🥀",
    "عـيـنـيـكِ قـصـة لا يـمـلُّ قـلـبـي مـن قـࢪاءتـهـا 💖🥀", "أنـتِ الـمـعـنـى ال_حـقـيـقـي لـلـجـمـال 💖🥀",
    ...
    "أنـتِ عـيـدي كـل يـوم وفـࢪحـي ال_دائـم 💖🥀", "بـكـل لـغـات الـعـالـم أحـبـكِ 💖🥀",
    "وجـودك هـو الأمـان الـذي أبـحـث عـنـه 💖🥀", "يـا وࢪدة قـلـبـي ويـا شـمـعـة دࢪبـي 💖🥀",
    "أنـتِ أجـمـل مـا حـدث لـي فـي حـيـاتـي 💖🥀", "أحـبـكِ حـبـاً يـتـجـاوز ال_خـيـال 💖🥀",
...
@app.on_message(filters.command(["قفل همسه", "فتح همسه", "قفل زاجل", "فتح زاجل", "قفل اهمسلي", "فتح اهمسلي"], "") & filters.group)
async def whispers_locks(client, m: Message):
    ...
    cmd = m.text
    if "همسه" in cmd and "اهمسلي" not in cmd:
        key, name = "whisper", "الـهـمـسـه"
    elif "زاجل" in cmd:
        key, name = "zajel", "الـزاجـل"
    else:
        key, name = "whisper_me", "اهمسلي"
    ...
    if "قفل" in cmd:
        ...
        if not current: return await m.reply_text(f"• عـمـࢪي {name} مـفـتـوحـه بـالـف_عـل ✨")
        await set_lock(m.chat.id, key, False)
        await m.reply_text(f"• تـم فـتـح {name} بـنـجـاح 🧚")

# --- [ نـظـام الـهـمـسـات والـزاجـل ] ---

@app.on_message(filters.command("همسه", "") & filters.group)
async def whisper_boda(_, m: Message):
    if await is_locked(m.chat.id, "whisper"): return await m.reply_text("• عـذراً الـهـمـسـه مـقـفـولـه مـن قـبـل الإدارة 🥀")
...
async def zajel_boda(_, m: Message):
    if await is_locked(m.chat.id, "zajel"): return await m.reply_text("• عـذراً الـزاجـل مـقـفـول مـن قـبـل الإدارة 🥀")
...
async def whisper_me_boda(_, m: Message):
    if await is_locked(m.chat.id, "whisper_me"): return await m.reply_text("• عـذراً أمـࢪ اهمسلي مـقـفـول مـن قـبـل الإدارة 🥀")
    w_id = f"s_{m.id}"
...
async def open_whisper(_, q: CallbackQuery):
    ...
    if not data: return await q.answer("الـهـمـسـه قـديـمـه")
