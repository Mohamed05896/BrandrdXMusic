...
locks_db = mongodb.BrandrdDB.locks_v5  # نسخة محدثة لضمان الاستجابة
whispers_db = {} 
...
SWEET_QUOTES = [
    ...
    "عـيـنـيـكِ قـصـة لا يـمـلُّ قـلـبـي مـن قـࢪاءتـهـا 💗🧚", "أنـتِ الـمـعـنـى الـحـقـيـقـي لـلـج_مـال 💗🧚",
    ...
    "أعـشـقـكِ حـتـى يـنـتـهـي الـعـشـق 💗🧚", "كـل عـام وأنـتِ مـلـكـة قـل_بـي 💗🧚"
]

# --- [ فلاتر الأوامر الذكية ] ---

@app.on_message(filters.regex(r"^(قفل|فتح)\s?(همسه|زاجل|الزاجل|اهمسلي)$") & filters.group)
