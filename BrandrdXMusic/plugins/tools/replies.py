...
locks_db = mongodb.BrandrdDB.locks_v3
whispers_db = {} 
...
SAD_QUOTES = [
    ...
    "أشـد أنـواع الـوجـع هـو أن تـنـام وأنـت تـب_كـي بـحـࢪقـة فـي قـلـبـك 🖤🥀", "سـلامـاً عـلـى قـلـوب قـࢪأت يُـدبّـر الأمـࢪ فـتـࢪكـت وجـعـهـا لـلـه 🖤🥀",
    "الـحـزن لا يـغـيـر الـمـاضـي لـكـنـه يـدمـر مـسـتـقـبـلـك 🖤🥀", "أسـوأ وداع هـو الـذي تـشـعـر فـيـه أنـك لـن تـࢪاه مـجـدداً 🖤🥀",
    "كـانـوا لـقـلـبـي حـيـاة والـيـوم هـم لـقـل_بـي وجـع 🖤🥀", "تـوقـف عـن لـوم نـفـسـك فـالـمـغـادر لـم يـكـن يـسـتـحـقـك 🖤🥀",
    ...
    "خـخـسـࢪنـاهـم لأنـهـم أࢪادوا الـخـسـاࢪة 🖤🥀", "كـنـت ال_مـأوى الـوحـيـد والآن أنـت الـغـࢪيـب 🖤🥀",
...
SWEET_QUOTES = [
    ...
    "سـأبـقـى أحـبـكِ حـتـى تـتـوقـفُ الـنـبـضـات 💖🥀", "أنـتِ ال_نـعـمـةُ الـتـي أشـكـرُ الـلـه عـلـيـهـا 💖🥀",
    ...
    "أحـبـكِ فـوق حـب الـم_حـبـيـن حـبـاً 💖🥀", "أنـتِ عـالـمـي ال_صـغـيـر الـتـي أهـࢪبُ إلـيـه 💖🥀",
    ...
    "أحـبـكِ بـكـل تـفـاصـي_لـك 💖🥀", "قـࢪبـك هـو جـنـتـي وبـعـدك هـو ضـيـاعـي 💖🥀",
...
@app.on_message(filters.regex(r"^(قفل|فتح) (همسه|زاجل|اهمسلي)$") & filters.group)
async def whispers_locks_handler(client, m: Message):
    ...
    text = m.text.strip()
    if "همسه" in text and "اهمسلي" not in text:
...
async def zajel_boda(_, m: Message):
    ...
    await m.reply_text(f"• عـمـࢪي {m.from_user.mention}\n• عـمـࢪي {target.mention}\n• هـمـسـه زاجـل مـشـتـࢪكـه",
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("ࢪؤيـة ال_زاجـل", callback_data=f"wh_{w_id}")]]))
